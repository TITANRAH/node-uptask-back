...
class ProjectController {
    static createProject = async (req, res) => {
        ...
        const project = new Proyect_1.default(req.body);
    ...
    static getAllProjects = async (req, res) => {
        try {
            const projects = await Proyect_1.default.find({
                $or: [
    ...
    static getProjectById = async (req, res) => {
        ...
        console.log(id);
        try {
            const project = await Proyect_1.default.findById(id).populate("tasks");
            if (!project) {
    ...
    static udpateProyect = async (req, res) => {
        try {
    ...
    static deleteProyect = async (req, res) => {
        const { id } = req.params;
        console.log(id);
        try {
